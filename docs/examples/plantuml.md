...
```plantuml
@startuml
title Flyt for å finne pantedokumenter i grunnboken

(*) --> "Get.Estate()"
if "Finnes borettsandel" then
    ->[true] "Hovedeiendom er borettsandel"
    --> ==IDENTIFISERT_HOVEDEIENDOM===
else
  --> [false] "Hovedeiendom er første matrikkel"
  --> ==IDENTIFISERT_HOVEDEIENDOM===
endif

--> "Hent hjemmelshavere på hovedeiendom"
